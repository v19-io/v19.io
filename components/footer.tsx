        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground max-w-xs leading-relaxed mb-6">
              Powering schools with Kanri and building custom websites that perform.
            </p>
          ...
          {/* Links */}
          <div>
            <h3 className="text-sm font-semibold text-foreground uppercase tracking-wider mb-4">Products</h3>
